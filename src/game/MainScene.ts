...
export const LEVELS: LevelDef[] = [
  {
    ...
    name: 'NEON STREETS', theme: 'streets', w: 5700, h: 780, spawn: [120, 500], goal: [5600, 540],
    ground: [[0, 760, 600], [940, 1560, 600], [1740, 2560, 600], [2740, 3800, 600], [3980, 4560, 600], [4740, 5700, 600]],
    plats: [[200, 430, 150], [1900, 410, 150], [2200, 390, 150], [3600, 360, 150], [4250, 410, 150], [5150, 400, 150]],
    walls: [
      ...
      [4980, 550, 190, 110], [5170, 490, 190, 230], [5360, 430, 190, 350],     // S6 end 3-step climb
    ],
    turrets: [[600, 490], [1350, 470], [3360, 430], [5360, 430]],
    enemies: [
      ...
      { kind: 'soldier', x: 5150, y: 566, hp: 3, speed: 70 }, { kind: 'tank', x: 5450, y: 560, hp: 7, speed: 30 },
      { kind: 'flyer', x: 1650, y: 280, hp: 3, speed: 52 }, { kind: 'flyer', x: 3250, y: 280, hp: 3, speed: 52 },
      { kind: 'flyer', x: 4900, y: 300, hp: 3, speed: 55 },
    ],
    pods: [[600, 460, 'spread'], [1350, 440, 'health'], [3360, 400, 'rapid'], [4250, 370, 'spread'], [5170, 440, 'health']],
    movers: [[850, 590, 120, 'h', 85, 0.9], [1650, 590, 130, 'h', 95, 0.9]],
    hazards: [[1000, 600, 110], [2350, 600, 120], [4350, 600, 120]],
  ...
  },
  {
    ...
    name: 'INDUSTRIAL RISE', theme: 'industrial', w: 5800, h: 800, spawn: [120, 500], goal: [5700, 540],
    ground: [[0, 700, 600], [880, 1440, 600], [1620, 2200, 600], [2380, 3900, 600], [4080, 4680, 600], [4860, 5800, 600]],
    plats: [[250, 430, 150], [1150, 420, 170], [3010, 400, 160], [3450, 400, 150], [4300, 410, 160], [5100, 400, 150]],
    walls: [
      ...
      [4750, 540, 180, 120], [4940, 470, 180, 260],            // S6 end staircase
    ],
    turrets: [[1950, 440], [2790, 470], [4940, 470]],
    enemies: [
      ...
      { kind: 'soldier', x: 5000, y: 566, hp: 3, speed: 70 }, { kind: 'soldier', x: 5500, y: 566, hp: 3, speed: 70 },
      { kind: 'flyer', x: 850, y: 300, hp: 3, speed: 55 }, { kind: 'flyer', x: 4700, y: 280, hp: 3, speed: 55 },
    ],
    pods: [[450, 500, 'rapid'], [1950, 400, 'health'], [2790, 430, 'laser'], [4940, 420, 'health']],
    movers: [[790, 590, 140, 'h', 90, 0.85], [1530, 590, 130, 'h', 95, 0.9], [2290, 500, 120, 'v', 150, 0.7], [4680, 590, 130, 'h', 90, 0.85]],
    hazards: [[1000, 600, 130], [2450, 600, 120], [4300, 600, 120]],
  ...
  },
  {
    ...
    name: 'SKY RAIL', theme: 'sky', w: 6000, h: 820, spawn: [120, 500], goal: [5900, 540],
    ground: [[0, 640, 600], [820, 1300, 600], [1480, 1960, 600], [2140, 2620, 600], [2800, 4000, 600], [4180, 4620, 600], [4800, 5200, 600], [5380, 6000, 600]],
    plats: [[300, 420, 140], [520, 350, 140], [920, 410, 150], [1650, 400, 150], [1850, 320, 150], [2400, 400, 150], [3120, 380, 150], [3500, 320, 150], [4300, 400, 150], [4700, 340, 150], [5100, 400, 150], [5550, 340, 150]],
    walls: [[1100, 540, 180, 120], [3300, 520, 180, 180], [5350, 520, 180, 180]],
    turrets: [[520, 350], [1850, 320], [3500, 320], [5550, 340]],
    enemies: [
      ...
      { kind: 'flyer', x: 4700, y: 260, hp: 4, speed: 70 },
    ],
    pods: [[520, 320, 'laser'], [1650, 370, 'health'], [3150, 350, 'fire'], [4700, 300, 'health']],
    movers: [[730, 590, 130, 'h', 95, 0.9], [1390, 590, 130, 'h', 95, 0.9], [2050, 500, 120, 'v', 160, 0.7], [2710, 590, 130, 'h', 95, 0.9], [4620, 590, 130, 'h', 95, 0.9]],
    hazards: [[950, 600, 110]],
    bouncers: [[400, 600, 90], [1700, 600, 90], [3200, 600, 90], [4400, 600, 90], [4950, 600, 90]],
  },
  {
    ...
    name: 'CORE ACCESS', theme: 'core', w: 5800, h: 780, spawn: [120, 500], goal: [5700, 540],
    ground: [[0, 760, 600], [940, 1520, 600], [1700, 2360, 600], [2540, 3900, 600], [4080, 4640, 600], [4820, 5800, 600]],
    plats: [[280, 430, 140], [1020, 410, 150], [2200, 400, 150], [3600, 380, 150], [4300, 410, 150], [5100, 400, 150]],
    walls: [
      ...
      [4950, 500, 180, 220], [5150, 440, 180, 320],            // S6 end staircase
    ],
    turrets: [[1200, 480], [2000, 480], [3100, 440], [5150, 440]],
    enemies: [
      ...
      { kind: 'charger', x: 4950, y: 566, hp: 5, speed: 66 }, { kind: 'soldier', x: 5300, y: 566, hp: 4, speed: 75 },
      { kind: 'tank', x: 5550, y: 560, hp: 9, speed: 32 },
      { kind: 'flyer', x: 850, y: 280, hp: 4, speed: 75 }, { kind: 'flyer', x: 4900, y: 280, hp: 4, speed: 80 },
    ],
    pods: [[500, 460, 'rapid'], [1400, 500, 'health'], [2000, 440, 'laser'], [3100, 400, 'fire'], [5150, 400, 'health']],
    movers: [[850, 590, 120, 'h', 85, 0.9], [1610, 590, 130, 'h', 95, 0.9], [2450, 590, 120, 'h', 85, 0.9], [4640, 590, 120, 'h', 85, 0.9]],
    hazards: [[650, 600, 110], [1050, 600, 120], [1780, 600, 120], [2700, 600, 120], [3450, 600, 120], [4300, 600, 120], [5250, 600, 120]],
