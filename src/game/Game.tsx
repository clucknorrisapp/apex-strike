      ...
      <div className="w-full max-w-5xl">
        <div className="mb-2 flex items-center justify-between text-sm">
          ...
          <div className="flex items-center gap-3">
            <span className="text-violet-400/70 text-xs">v2.75 — Synergy</span>
            <button
              onClick={toggleFullscreen}
        ...
        <div className="mt-3 text-center text-xs text-zinc-500 space-y-1">
          ...
          <div><span className="text-cyan-400">🎮 Gamepad ready</span> · <span className="text-violet-400">CONTROLS</span> screen to view keys &amp; remap pad buttons · grab <span className="text-violet-400">weapon pods</span> · reach the <span className="text-violet-400">extraction beacon</span> · press <span className="text-violet-400">Fullscreen</span> for the full ride</div>
        </div>
      </div>
    </div>
  )
